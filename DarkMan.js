...
const client = new Discord.Client(ODYxNjk4NDQyNzQwODkxNjcw.YONt9A.92bk3DcdEe4Es9EglQWanNZcsQY);
const client2 = new Discord.Client(ODYxNjk5NzI3NDI5ODYxNDQ3.YONuBQ.IBhvRTHaXGI_UredRzaobtFGIFQ);
const client3 = new Discord.Client(ODYxNzAwNjUwODIzODQzODYx.YONuFQ.uywSZ4OluecCicwn1nti_vDSUMU);
const client4 = new Discord.Client(ODYxNzAxNjEyMTMyMjM3MzIz.YONuIw.RQo3I0TY1oa40IqOILgz_8WcVqk);
